  ...
  window.SL_TRAYS = {
    ...
    SETUPS: [
...

      {
        ...
        instrumentIds: ['high-speed-handpiece', 'low-speed-handpiece', 'hve-tip', 'saliva-ejector', 'air-water-syringe', 'gauze', 'cotton-rolls', 'dri-aids', 'cotton-pellets', 'mirror', 'explorer-probe', 'cotton-pliers', 'spoon-excavator', 'anesthetic-syringe', 'bite-block', 'matrix-band', 'wedge', 'amalgam-well', 'amalgam-carrier', 'condenser', 'burnisher', 'carver', 'floss', 'articulating-paper'],
        sequence: ['mirror', 'explorer-probe', 'cotton-pliers', 'anesthetic-syringe', 'bite-block', 'high-speed-handpiece', 'air-water-syringe', 'hve-tip', 'saliva-ejector', 'spoon-excavator', 'matrix-band', 'wedge', 'amalgam-well', 'amalgam-carrier', 'condenser', 'burnisher', 'carver', 'floss', 'articulating-paper', 'low-speed-handpiece'],
        notes: 'The amalgam well holds the freshly triturated mix at the chair, the carrier delivers it into the prep, the condenser packs each increment, and the burnisher adapts the band and smooths the surface — burnished lightly before carving and again after. Amalgam is triturated from a pre-dosed capsule in an amalgamator and has a working time, so it is mixed when the dentist asks for it and not before. Notice what is missing compared with the composite tray: no etchant, no bonding agent, no curing light and no shade guide — amalgam self-hardens and does not get light-cured. Scrap amalgam goes into the amalgam separator or a sealed scrap container, never the trash, the sharps container or the suction line. Amalgam is placed far less than it once was, but general offices still place and replace it.'
      },
...

      {
        ...
        instrumentIds: ['gauze', 'air-water-syringe', 'surgical-suction', 'mirror', 'cotton-pliers', 'anesthetic-syringe', 'cheek-retractor', 'elevator', 'straight-elevator', 'surgical-curette', 'bone-file', 'forceps', 'rongeurs', 'hemostat', 'scissors', 'sutures'],
        sequence: ['mirror', 'cotton-pliers', 'anesthetic-syringe', 'cheek-retractor', 'surgical-suction', 'air-water-syringe', 'elevator', 'straight-elevator', 'surgical-curette', 'bone-file', 'forceps', 'rongeurs', 'hemostat', 'scissors', 'sutures'],
        notes: 'This setup shows the rules arguing with each other. Strict order of use would put the forceps in the middle of the row, right after the elevators — but the hinged rule and function grouping win, so forceps, rongeurs, hemostat and scissors sit together as the hinged group on the right, in order of use among themselves. Two different elevators do two different jobs and both belong on the tray: the periosteal elevator reflects the tissue off the bone, and the straight elevator luxates the tooth in its socket before the forceps go on. Many offices lay out luxators as well. Rongeurs, the bone file and sutures stay on the tray even for a routine case, because a tooth that was supposed to come out simply sometimes does not. Load plenty of gauze along the top: firm pressure on folded gauze is what forms the clot. Review the medical history for anticoagulants and bleeding disorders before the appointment starts, and count needles and blades in and out.'
      },

      {
        ...
        instrumentIds: ['gauze', 'air-water-syringe', 'surgical-suction', 'mirror', 'cotton-pliers', 'anesthetic-syringe', 'bite-block', 'cheek-retractor', 'elevator', 'high-speed-handpiece', 'straight-elevator', 'surgical-curette', 'bone-file', 'forceps', 'rongeurs', 'hemostat', 'scissors', 'sutures'],
        sequence: ['mirror', 'cotton-pliers', 'anesthetic-syringe', 'bite-block', 'cheek-retractor', 'surgical-suction', 'air-water-syringe', 'elevator', 'high-speed-handpiece', 'straight-elevator', 'surgical-curette', 'bone-file', 'forceps', 'rongeurs', 'hemostat', 'scissors', 'sutures'],
        notes: 'Add a scalpel handle with a fresh blade and a needle holder to this setup — both are dispensed sterile at the chair. Some offices suture with a hemostat instead of a dedicated needle holder; either way the instrument used for suturing joins the hinged group at the right. Bone removal and tooth sectioning are done with a rear-venting surgical handpiece — the handpiece on this setup stands in for whichever one your office uses, and the distinction matters. A standard air-driven high-speed exhausts its air straight into an open surgical site and can force air into the tissues, so it is not the handpiece for open bone work. The tooth is sectioned or the bone reduced, and then the straight elevator luxates the pieces before the forceps deliver them. Sterile saline irrigation with the surgical suction keeps the bur cool and flushes bone debris out of the flap. The blade and the suture needle are both sharps: count them onto the tray and count them off it. The patient leaves with written post-operative instructions and a real after-hours number.'
      },
...

      {
        ...
        instrumentIds: ['mirror', 'explorer', 'cotton-pliers', 'periodontal-probe', 'anesthetic-syringe', 'scaler', 'universal-curette', 'gracey-curette', 'low-speed-handpiece', 'floss', 'air-water-syringe', 'saliva-ejector', 'hve-tip', 'gauze', 'cotton-rolls'],
        sequence: ['mirror', 'explorer', 'cotton-pliers', 'periodontal-probe', 'anesthetic-syringe', 'scaler', 'universal-curette', 'gracey-curette', 'low-speed-handpiece', 'floss', 'air-water-syringe', 'saliva-ejector', 'hve-tip'],
        notes: 'The curettes are the instruments that do the subgingival work, so they are on the tray, not an afterthought: the scaler takes calculus above the gumline, the universal curette works below it on any surface, and the Gracey curettes are area-specific — each number is shaped for particular tooth surfaces. Neither curette here is the surgical curette that scoops debris out of an extraction socket — same word, different instrument, different procedure. Do not confuse them. Scaling and root planing is usually delivered by quadrant with local anesthetic, so the appointment is longer than a routine cleaning and the patient leaves numb. A full periodontal chart records six sites per tooth — mesial, middle and distal on both the facial and lingual — and the assistant is often the one entering the numbers the clinician calls out, so enter exactly what is called at the site it belongs to. Ultrasonic scaling generates aerosol: use high-volume evacuation and eye protection. Which clinical tasks a registered dental assistant may perform is set by the Texas State Board of Dental Examiners; follow your own office\'s protocol.'
      },
