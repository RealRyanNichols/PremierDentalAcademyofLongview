  ...
  var SCENARIOS = [
    {
      ...
      steps:[
        ...
        { speaker:'dentist', category:'Morning Setup', type:'instrument',
          prompt:'"Tray looks right. Pop quiz while we\'re early — when I want to see the back of her last molar without her turning her head, which one do I pick up?"',
          options:['mirror','explorer','cotton-pliers','periodontal-probe'],
          answer:0, explanation:'The mouth mirror gives indirect vision — you see surfaces you can\'t look at directly, and it also retracts the cheek or tongue and reflects light onto the field.' },
        { speaker:'dentist', category:'Morning Setup', type:'instrument',
          prompt:'"And when I find a suspicious groove and want to feel whether it\'s sticky with decay?"',
          options:['explorer','periodontal-probe','spoon-excavator','scaler'],
          answer:0, explanation:'The explorer\'s fine, sharp tip detects caries by feel — a sticky catch in a groove signals softened enamel. The probe measures pockets, the spoon excavator removes decay once found, and the scaler removes calculus.' }
      ]
    },
    {
      ...
      steps:[
        ...
        { speaker:'dentist', category:'Crown Prep', type:'instrument',
          prompt:'"Time for the cord — I need to seat it into the sulcus before we take the impression. Hand me…"',
          options:['cord-packer','condenser','spoon-excavator','periodontal-probe'],
          answer:0, explanation:'The cord packer\'s serrated working end seats retraction cord into the sulcus without cutting the tissue. A condenser packs restorative material, a spoon excavator removes soft decay, and a perio probe measures pocket depth.' },
        { speaker:'dentist', category:'Crown Prep', type:'instrument',
          prompt:'"Cord\'s out and the margin is dry. I\'m loading the tray with heavy body — syringe the wash material around the prep so we capture the margin detail."',
          options:['light-body','heavy-body','bite-registration','temp-crown-material'],
          answer:0, explanation:'Light body is the thin wash syringed directly around the prep to record fine margin detail; the heavy body in the tray carries it. Bite registration records occlusion, and temp crown material builds the provisional — neither captures the margin.' },
        { speaker:'dentist', category:'Crown Prep', type:'instrument',
          prompt:'"Great impression. Now let\'s protect the prep while the lab works — what material do I load into the matrix to form her provisional?"',
          options:['temp-crown-material','cement','composite','bite-registration'],
          answer:0, explanation:'Temporary crown material (provisional resin) is formed in a matrix over the prep to fabricate the temporary. Cement seats it afterward; composite is a filling material; bite registration only records how the teeth close.' },
        { speaker:'dentist', category:'Crown Prep', type:'choose',
    ...
    },
    {
      ...
      steps:[
        ...
        { speaker:'dentist', category:'Composite', type:'instrument',
          prompt:'"This is a Class II — the wall between the teeth is gone. What do I need around the tooth so there\'s a wall to pack against?"',
          options:['matrix-band','wedge','bite-block','articulating-paper'],
          answer:0, explanation:'The Tofflemire matrix band recreates the missing proximal wall so composite can be packed against it. The wedge only adapts the band at the gumline, a bite block props the mouth open, and articulating paper checks the bite at the end.' },
        { speaker:'dentist', category:'Composite', type:'instrument',
          prompt:'"Band\'s seated. Now snug it tight against the tooth at the gumline so we get a closed contact — what goes between the teeth?"',
          options:['wedge','cotton-rolls','cotton-pellets','floss'],
          answer:0, explanation:'A wedge placed interproximally presses the matrix band against the margin and separates the teeth slightly, giving a tight contact. Cotton rolls and pellets are for isolation and drying; floss checks the contact afterward.' },
        ...
        { speaker:'dentist', category:'Composite', type:'instrument',
          prompt:'"That increment is packed and shaped — nothing else happens until it\'s set hard. What do I need in my hand right now?"',
          options:['curing-light','air-water-syringe','shade-guide','bond'],
          answer:0, explanation:'Composite is light-cured: the blue curing light hardens each increment before the next goes in. Rinsing now would contaminate the resin, the shade was matched before the prep, and the bonding agent was already placed and cured.' },
        { speaker:'dentist', category:'Composite', type:'choose',
    ...
    },
    {
      ...
      steps:[
        ...
        { speaker:'dentist', category:'Extraction', type:'instrument',
          prompt:'"Joyce is numb and I\'m starting. First I need to lift the gum tissue away from the bone for access. Pass me the…"',
          options:['elevator','forceps','surgical-curette','hemostat'],
          answer:0, explanation:'The periosteal elevator reflects and lifts the gingiva/periosteum off the bone before anything else. Forceps come later to deliver the tooth, the curette cleans the socket afterward, and a hemostat grasps tissue or items.' },
        { speaker:'dentist', category:'Extraction', type:'instrument',
          prompt:'"Blood is pooling and I\'m losing sight of the site. Which suction tip goes to work?"',
          options:['surgical-suction','saliva-ejector','hve-tip','air-water-syringe'],
          answer:0, explanation:'The narrow-bore surgical suction tip is made for blood and debris right at a surgical site. The saliva ejector is low-volume for pooled saliva, the HVE is the wide tip for handpiece spray, and the air-water syringe adds fluid — the opposite of what you need.' },
        { speaker:'dentist', category:'Extraction', type:'instrument',
          prompt:'"Tooth\'s coming… and it\'s out. Before we pack the site, I\'ll clean the granulation tissue out of the socket. Hand me the…"',
          options:['surgical-curette','spoon-excavator','bone-file','elevator'],
          answer:0, explanation:'The surgical curette scoops granulation tissue and debris out of the extraction socket so it heals cleanly. A spoon excavator removes soft decay from a cavity prep, the bone file smooths bone edges, and the elevator already did its job.' },
        { speaker:'dentist', category:'Extraction', type:'choose',
        ...
        { speaker:'patient', category:'Extraction', type:'multi',
          prompt:'"What do I do at home tonight?"',
          hint:'Select the correct post-op instructions.',
    ...
    },
    {
      ...
      steps:[
        { speaker:'frontdesk', category:'Emergency', type:'choose',
          prompt:'"Tyler called — severe lower-left pain since last night. Can we squeeze him in? He\'s here now."',
          hint:'Your first step when Tyler comes back:',
        ...
        { speaker:'patient', category:'Emergency', type:'choose',
          prompt:'"It\'s a sharp, throbbing pain in my lower left, worse with cold. It kept me up all night."',
          hint:'You relay to the doctor that this most likely needs:',
        ...
        { speaker:'dentist', category:'Emergency', type:'instrument',
          prompt:'"X-ray\'s up. Before I call it, I want to test the tooth — dry it off and give it a light blast of air to see if it reacts. Hand me the…"',
          options:['air-water-syringe','hve-tip','saliva-ejector','cotton-pliers'],
          answer:0, explanation:'The air-water syringe tip dries the tooth and delivers the controlled puff of air used to test sensitivity. The HVE and saliva ejector remove fluid rather than deliver air, and cotton pliers only carry small items.' },
        { speaker:'dentist', category:'Emergency', type:'instrument',
          prompt:'"I also want to rule out a gum abscess before I blame the pulp — I\'ll walk the pocket depths around #18. Which instrument do I need?"',
          options:['periodontal-probe','explorer','endo-explorer','scaler'],
          answer:0, explanation:'The periodontal probe is the only instrument marked in millimeters for measuring sulcus/pocket depth — a deep, isolated pocket points to a perio problem. Explorers detect decay by feel and a scaler removes calculus.' },
        { speaker:'dentist', category:'Emergency', type:'choose',
  ...
  ,
    {
      ...
      steps:[
        ...
        { speaker:'patient', category:'Medical History', type:'choose',
          prompt:'While you review her history, the patient mentions: "I take a blood thinner every day."',
          hint:'What do you do?',
        ...
        { speaker:'dentist', category:'Seating Patients', type:'instrument',
          prompt:'"Thanks for flagging that pressure — I\'ll keep an eye on it. For the exam, I want to check the tongue side of her lower front teeth without making her crane her neck. Set that one out first."',
          options:['mirror','explorer','periodontal-probe','cotton-pliers'],
          answer:0, explanation:'The mouth mirror provides indirect vision of surfaces you can\'t see straight-on, retracts the cheek and tongue, and reflects light onto the field — it starts every exam.' },
        { speaker:'dentist', category:'Medical History', type:'instrument',
          prompt:'"The health history says the gums bleed with flossing. I\'ll want to measure the sulcus depths — make sure this is on my tray."',
          options:['periodontal-probe','explorer','scaler','spoon-excavator'],
          answer:0, explanation:'Bleeding gums call for pocket measurements, and the periodontal probe is the millimeter-marked instrument that measures sulcus depth. The explorer checks for decay; the scaler treats calculus rather than measures.' }
      ]
    },
    {
    ...
    },
    {
      ...
      steps:[
        ...
        { speaker:'narrator', category:'X-Ray Positioning', type:'instrument',
          prompt:'Saliva keeps pooling under the sensor between exposures and the patient is struggling to hold still. You clear it with:',
          options:['saliva-ejector','hve-tip','air-water-syringe','gauze'],
          answer:0, explanation:'The saliva ejector is the low-volume tip made for removing pooled saliva while the patient sits — perfect between exposures. The HVE is the wide, high-volume tip for handpiece spray, and the air-water syringe would add water.' },
        ...
        { speaker:'dentist', category:'X-Ray Error Recognition', type:'instrument',
          prompt:'"Nice series. There\'s a shadow on the distal of #30 — before I diagnose it, I want to check that surface by feel. Bring me the…"',
          options:['explorer','periodontal-probe','spoon-excavator','mirror'],
          answer:0, explanation:'The explorer\'s sharp tip confirms what the x-ray suggests — a catch or stick on the surface means softened, carious tooth structure. The probe measures gum pockets and the mirror only lets the dentist see, not feel.' }
      ]
    },
    {
      ...
      steps:[
        ...
        { speaker:'narrator', category:'Impressions', type:'instrument',
          prompt:'The alginate is mixed smooth and creamy, and the clock is running. You load it into the:',
          options:['impression-tray','bite-block','dam-frame','cheek-retractor'],
          answer:0, explanation:'The impression tray holds the alginate and carries it to the arch — load it evenly from the back forward. A bite block props the mouth open, the dam frame stretches a dental dam, and a cheek retractor is for surgical access.' },
        { speaker:'narrator', category:'Impressions', type:'choose',
        ...
        { speaker:'dentist', category:'Impressions', type:'instrument',
          prompt:'"While you\'ve got the patient — the lab also needs a record of exactly how the upper and lower teeth close together. Grab the…"',
          options:['bite-registration','heavy-body','light-body','etch'],
          answer:0, explanation:'Bite registration material sets fast between the arches and records the occlusion so the lab can articulate the models. Heavy and light body are crown-impression materials, and etchant is a bonding step — not a record of the bite.' },
        { speaker:'narrator', category:'Impressions', type:'choose',
    ...
    },
    {
      ...
      steps:[
        ...
        { speaker:'dentist', category:'Charting', type:'instrument',
          prompt:'"We\'re charting all four quadrants today, six sites a tooth, and you\'re on the keyboard. Which instrument will be in my hand the whole time?"',
          options:['periodontal-probe','explorer','endo-explorer','scaler'],
          answer:0, explanation:'The periodontal probe, with its millimeter markings, is the instrument that measures every sulcus depth you\'ll be recording. Explorers detect decay by feel and the scaler removes calculus after charting.' },
        ...
        { speaker:'dentist', category:'Charting', type:'instrument',
          prompt:'"There\'s heavy tartar above the gumline on the lower front teeth. Once the chart is done, what comes off the tray to remove it?"',
          options:['scaler','spoon-excavator','carver','surgical-curette'],
          answer:0, explanation:'The scaler removes supragingival calculus (tartar above the gumline). A spoon excavator removes soft decay, a carver shapes restorations, and a surgical curette cleans extraction sockets.' },
        { speaker:'narrator', category:'Charting', type:'choose',
    ...
    },
    {
      ...
      steps:[
        ...
        { speaker:'dentist', category:'Four-Handed Assisting', type:'instrument',
          prompt:'"I\'m about to run the high-speed with full water spray on the lower right. Which suction tip goes in your hand?"',
          options:['hve-tip','saliva-ejector','surgical-suction','air-water-syringe'],
          answer:0, explanation:'Whenever the high-speed handpiece runs, the high-volume evacuator keeps up with the water spray and controls aerosol. The saliva ejector is too slow for handpiece spray, and surgical suction is for blood at a surgical site.' },
        { speaker:'dentist', category:'Four-Handed Assisting', type:'instrument',
          prompt:'"Prep\'s cut. Rinse the debris out and dry it so I can inspect before we restore. What are you reaching for?"',
          options:['air-water-syringe','hve-tip','cotton-pellets','gauze'],
          answer:0, explanation:'The air-water syringe tip rinses the prep with water or spray and then dries it with air — rinse and dry is its whole job. The HVE removes what you rinse; pellets and gauze only blot small areas.' },
        { speaker:'narrator', category:'Four-Handed Assisting', type:'choose',
  ...
  var DAY_SHIFT = [
    {
      ...
      steps:[
        ...
        { speaker:'dentist', category:'Day Shift', type:'instrument',
          prompt:'"Priya mentioned her gums bleed when she flosses — I\'ll measure her pocket depths during the exam. Hand me the…"',
          options:['periodontal-probe','explorer','scaler','cotton-pliers'],
          answer:0, explanation:'The periodontal probe\'s millimeter markings measure sulcus and pocket depth — exactly what bleeding gums call for. The explorer checks for decay by feel; the scaler removes calculus rather than measures.' },
        { speaker:'dentist', category:'Day Shift', type:'choose',
    ...
    },
    {
      ...
      steps:[
        ...
        { speaker:'dentist', category:'Day Shift', type:'instrument',
          ...
          options:['hve-tip','saliva-ejector','surgical-suction','air-water-syringe'],
          answer:0, explanation:'The high-volume evacuator is the only tip that keeps up with high-speed water spray and controls aerosol. The saliva ejector is low-volume for pooled saliva, and surgical suction belongs at a surgical site.' },
        { speaker:'narrator', category:'Day Shift', type:'choose',
        ...
        { speaker:'dentist', category:'Day Shift', type:'instrument',
          prompt:'"Margin\'s ready — I need to pack the cord before we take the impression. Hand me…"',
          options:['cord-packer','condenser','cotton-pliers','spoon-excavator'],
          answer:0, explanation:'The cord packer\'s serrated end seats retraction cord into the sulcus to expose the margin for the impression. A condenser packs filling material, cotton pliers carry small items, and the spoon excavator removes soft decay.' },
        { speaker:'dentist', category:'Day Shift', type:'choose',
    ...
    },
    {
      ...
      steps:[
        ...
        { speaker:'dentist', category:'Day Shift', type:'instrument',
          prompt:'"She\'s numb — I\'ll lift the gum tissue off the bone first for access. Pass me the…"',
          options:['elevator','forceps','hemostat','surgical-curette'],
          answer:0, explanation:'The periosteal elevator reflects the gingiva and periosteum off the bone before the tooth is touched. Forceps deliver the tooth later, the hemostat grasps tissue or items, and the curette cleans the socket at the end.' },
        { speaker:'dentist', category:'Day Shift', type:'instrument',
          prompt:'"Blood\'s pooling in the site and I can\'t see. Which tip clears it?"',
          options:['surgical-suction','saliva-ejector','hve-tip','air-water-syringe'],
          answer:0, explanation:'The narrow surgical suction tip is designed for blood and debris right at the surgical site. The saliva ejector is too weak, the HVE is the wide tip for handpiece spray, and the air-water syringe adds fluid.' },
        { speaker:'dentist', category:'Day Shift', type:'choose',
    ...
    },
    {
      ...
      steps:[
        { speaker:'frontdesk', category:'Day Shift', type:'choose',
          prompt:'"I squeezed Tyler into your 1:30 — severe lower-left pain since last night. He\'s checking in now."',
          hint:'When he comes back, your first step:',
        ...
        { speaker:'dentist', category:'Day Shift', type:'instrument',
          prompt:'"Image\'s up. Before I call it, I want to dry the tooth and air-test it. Hand me the…"',
          options:['air-water-syringe','saliva-ejector','hve-tip','cotton-pliers'],
          answer:0, explanation:'The air-water syringe tip dries the tooth and delivers the gentle puff of air used to test for sensitivity. Suction tips remove fluid instead of delivering air, and cotton pliers only carry small items.' },
        { speaker:'patient', category:'Day Shift', type:'choose',
          prompt:'"Am I going to lose the tooth? How much will this cost?"',
          hint:'He\'s anxious. Your best response:',
