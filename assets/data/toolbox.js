...
(function () {
  ...
  var TOOLS = [
    ...
    { id:'tray-builder', name:'Tray setup builder', href:'/skills-lab/tray-builder', emoji:'🗄️', situation:'learning', type:'drill', cost:'free',
      blurb:'Build the tray for each procedure and get graded against the real arrangement rules.' },
