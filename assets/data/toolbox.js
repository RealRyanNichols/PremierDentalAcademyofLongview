...
(function () {
  ...
  var TOOLS = [
    ...
    { id:'texas-rda-timeline', name:'Texas RDA credential timeline', href:'/tools/texas-rda-timeline', emoji:'🗂️', situation:'exam', type:'reference', cost:'free', isNew:true,
      blurb:'Every step to registration in order, what to bring to each, and who makes the decision. Printable.' },
    ...
    { id:'dental-bill-decoder', name:'Dental bill & insurance decoder', href:'/tools/dental-bill-decoder', emoji:'🧾', situation:'hired', type:'reference', cost:'free', isNew:true,
      blurb:'Deductible, annual maximum, downgrade, UCR — the vocabulary the front desk needs cold.' },
